...
RSpec.describe MunicipiosController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested municipio as @municipio" do
      municipio = Municipio.create! valid_attributes
      get :show, params: {id: municipio.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested municipio as @municipio" do
      municipio = Municipio.create! valid_attributes
      get :edit, params: {id: municipio.to_param}, session: valid_session
      expect(assigns(:municipio)).to eq(municipio)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Municipio" do
        expect {
          post :create, params: {municipio: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved municipio as @municipio" do
        post :create, params: {municipio: invalid_attributes}, session: valid_session
        expect(assigns(:municipio)).to be_a_new(Municipio)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested municipio" do
        municipio = Municipio.create! valid_attributes
        put :update, params: {id: municipio.to_param, municipio: new_attributes}, session: valid_session
        municipio.reload
      ...
      it "assigns the requested municipio as @municipio" do
        municipio = Municipio.create! valid_attributes
        put :update, params: {id: municipio.to_param, municipio: valid_attributes}, session: valid_session
        expect(assigns(:municipio)).to eq(municipio)
      end
    ...
    context "with invalid params" do
      it "assigns the municipio as @municipio" do
        municipio = Municipio.create! valid_attributes
        put :update, params: {id: municipio.to_param, municipio: invalid_attributes}, session: valid_session
        expect(assigns(:municipio)).to eq(municipio)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested municipio" do
      municipio = Municipio.create! valid_attributes
      expect {
        delete :destroy, params: {id: municipio.to_param}, session: valid_session
      }.to change(Municipio, :count).by(-1)
    end
