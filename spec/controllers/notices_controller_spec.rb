...
RSpec.describe NoticesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested notice as @notice" do
      notice = Notice.create! valid_attributes
      get :show, params: {id: notice.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested notice as @notice" do
      notice = Notice.create! valid_attributes
      get :edit, params: {id: notice.to_param}, session: valid_session
      expect(assigns(:notice)).to eq(notice)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Notice" do
        expect {
          post :create, params: {notice: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved notice as @notice" do
        post :create, params: {notice: invalid_attributes}, session: valid_session
        expect(assigns(:notice)).to be_a_new(Notice)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested notice" do
        notice = Notice.create! valid_attributes
        put :update, params: {id: notice.to_param, notice: new_attributes}, session: valid_session
        notice.reload
      ...
      it "assigns the requested notice as @notice" do
        notice = Notice.create! valid_attributes
        put :update, params: {id: notice.to_param, notice: valid_attributes}, session: valid_session
        expect(assigns(:notice)).to eq(notice)
      end
    ...
    context "with invalid params" do
      it "assigns the notice as @notice" do
        notice = Notice.create! valid_attributes
        put :update, params: {id: notice.to_param, notice: invalid_attributes}, session: valid_session
        expect(assigns(:notice)).to eq(notice)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested notice" do
      notice = Notice.create! valid_attributes
      expect {
        delete :destroy, params: {id: notice.to_param}, session: valid_session
      }.to change(Notice, :count).by(-1)
    end
